                ...
                child: Column(
                  children: [
                       ...
                       Stack(
                        children: [
                                  ...
                                  InkWell(
                                   onTap: (){
                                     ...
                                     child: Padding(
                                       ...
                                       child: Text('Skip',style: GoogleFonts.openSans(fontWeight:FontWeight.w400,color: Colors.black45,fontSize:20),),
                                     )
                                  )
                          ...
                          Positioned(
                            top: 0,
                            right: 0,
                            child: Image.asset(ImageAssets.greencolor,height:MediaQuery.of(context).size.height*.26,width: MediaQuery.of(context).size.width*.55,),),
                    ...
                    Padding(
                      ...
                      child: Text("Username",style: GoogleFonts.poppins(fontWeight: FontWeight.w400,color: Colors.black45,fontSize: 20),),
                    ),
                    Padding(
                    ...
                    Padding(
                      ...
                      child: Text("Email",style: GoogleFonts.poppins(fontWeight: FontWeight.w400,color: Colors.black45,fontSize: 20),),
                    ),
                    Padding(
                    ...
                    Padding(
                      ...
                      child: Text("Location",style: GoogleFonts.poppins(fontWeight: FontWeight.w400,color: Colors.black45,fontSize: 20),),
                    ),
                    Padding(
                    ...
                    Padding(
                      ...
                      child: Text("Phone Number",style: GoogleFonts.poppins(fontWeight: FontWeight.w400,color: Colors.black45,fontSize: 20),),
                    ),
                    Padding(
                      padding: EdgeInsets.symmetric(vertical: 0,horizontal: MediaQuery.of(context).size.width*.06),
                      child: TextFormField(
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Text("Completed",style: GoogleFonts.openSans(fontSize: 29,fontWeight: FontWeight.w400,color: Colors.white),),
                        ),
