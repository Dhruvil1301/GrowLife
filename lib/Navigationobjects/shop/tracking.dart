      ...
      appBar:   AppBar(
        ...
        title: Row(
          children: [
            ...
            Text("Tracking",style: GoogleFonts.lato(color: Colors.black,fontSize:  MediaQuery.of(context).size.height*.03,),),
          ],
        ),
      ),
      backgroundColor: Colors.white,
              ...
              color: Colors.black.withOpacity(.05),
                ...
                child:Column(
                  children: [
                    ...
                    Text("Estimated Delivery",style: GoogleFonts.lato(fontSize: MediaQuery.of(context).size.height*.023,fontWeight: FontWeight.bold),),
                    SizedBox(height: MediaQuery.of(context).size.height*.006),
                    Text("30 Jul 2023 : 05:30 PM",style: GoogleFonts.lato(fontSize: MediaQuery.of(context).size.height*.023,wordSpacing: 4,color: Colors.black54),)
              ...
              color: Colors.black.withOpacity(.1),
                child: Padding(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("Track Order",style: GoogleFonts.lato(fontWeight:FontWeight.bold,fontSize:MediaQuery.of(context).size.height*.022 ),),
                      Text("#1000205",style: GoogleFonts.lato(fontSize:MediaQuery.of(context).size.height*.022,color: Colors.black54),),
                    ],
                  ),
                )
                        ...
                        Column(
                          ...
                          children: [
                            Text("Parcale Delivered"
                              ,
                              style: TextStyle(fontWeight: FontWeight.bold,fontSize:MediaQuery.of(context).size.height*.02 ),
                            ),
                            Row(
                              children: [
                                Icon(Icons.access_time,color: Colors.black26,size:MediaQuery.of(context).size.height*.02 ,),
                                Text("12:10 AM, 30 Jul 2023",style: GoogleFonts.lato(color: Colors.black26),),
                              ],
                            ),
                          ],
                        ),
                                 ...
                                 children: <TextSpan>[
                                         TextSpan(
                                             text: 'Mob number: ',
                                              ...
                                              TextSpan(text:"+91 9667839945" ,style: GoogleFonts.lato(color: Colors.black,fontSize:MediaQuery.of(context).size.height*.020 )),
                                           ],
                                             ),
                                               ),
                    )
                ...
                child: Column(
                  children: [
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Text("Driver Details :",style: GoogleFonts.lato(fontWeight: FontWeight.bold,fontSize:MediaQuery.of(context).size.height*.022 ),),
                          SizedBox(width: MediaQuery.of(context).size.height*.01,),
                    ...
                    Row(
                      children: [
                        Container(
                          ...
                          child: Image.asset("assets/shop/deliveryboy.png",fit: BoxFit.contain,),
                        ),
                        Row(
                          children: [
                            Padding(
                              ...
                              child: Column(
                                ...
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text("Viraj Shah",style: GoogleFonts.lato(fontSize:MediaQuery.of(context).size.height*.02,fontWeight: FontWeight.bold ),),
                                  Text("+91 9634583105",style: GoogleFonts.lato(),),
             ...
             Padding(
               ...
               child: Column(
                 children: [
                   Row(
                     children: [
                       Icon(Icons.headset_mic_outlined,color:Colors.black,size:MediaQuery.of(context).size.height*.03 ,),
                       SizedBox(width: MediaQuery.of(context).size.width*.02,),
                       Text("Customer Help",style: GoogleFonts.lato(fontWeight: FontWeight.bold,fontSize:MediaQuery.of(context).size.height*.022),),
                     ],
                   ),
                   SizedBox( height: MediaQuery.of(context).size.height*.01),
                   Text("Our customer support team is ready to help with any inquiries or concerns. Reach out, and we'll take care of the rest.",style: GoogleFonts.lato(fontSize:MediaQuery.of(context).size.height*.018 ),),
                   SizedBox( height: MediaQuery.of(context).size.height*.02),
                   Container(
                     alignment: AlignmentDirectional.topStart,
                     child: Container(
                       ...
                       child: Center(child: Text("Get Help",style: GoogleFonts.lato(fontWeight: FontWeight.bold,fontSize: MediaQuery.of(context).size.height*.022,color: Colors.white ),)),
                     ),
                   )
                 ],
               ),
        ...
        Column(
          ...
          children: [
            ...
            Row(
              children: [
                Icon(Icons.access_time,color: Colors.black26,size:MediaQuery.of(context).size.height*.02 ,),
                Text(time,style: GoogleFonts.lato(color: Colors.black26),),
              ],
            ),
          ],
        ),
